package com.example.shreeleathers.Controllers.BO.Entry;
...
public class EntryController implements Initializable {
    ...
    public Text disp_curr_stock_lbl;
    public Text exchange_item_lbl;
    public Text purchase_return_lbl;
    public Text sales_return_lbl;
    public Text stock_adj_debit_note_lbl;
    public Text repair_memo_lbl;
